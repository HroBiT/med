                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white shadow-md rounded-lg overflow-hidden">
                            <div className="relative">
                                <img src="lekarz.jpg" alt="Doctor in surgical attire" className="w-full h-48 object-cover"/>
                            ...
                            <div className="p-4">
                                ...
                                <button className="mt-4 w-full bg-blue-500 text-white text-sm font-semibold py-2 rounded hover:bg-blue-600">Learn More</button>
                            </div>
                        </div>
                        <div className="bg-white shadow-md rounded-lg overflow-hidden">
                            <div className="relative">
                                <img src="lekarz.jpg" alt="Doctor in lab coat with mask" className="w-full h-48 object-cover"/>
                                <span className="absolute top-2 left-2 bg-red-500 text-white text-xs font-semibold px-2 py-1 rounded">Sale</span>
                            </div>
                            <div className="p-4">
                                <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="bg-white shadow-md rounded-lg overflow-hidden">
                            <div className="relative">
                                <img src="lekarz.jpg" alt="Medical equipment" className="w-full h-48 object-cover"/>
                                <span className="absolute top-2 left-2 bg-red-500 text-white text-xs font-semibold px-2 py-1 rounded">Sale</span>
                            </div>
                            <div className="p-4">
                                <div className="flex items-center justify-between mb-2">

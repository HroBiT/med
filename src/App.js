      ...
      <main className="flex flex-col items-start justify-center px-6 py-12 lg:flex-row lg:items-center lg:justify-between lg:px-24 lg:py-24">
        <div className="max-w-lg">
          ...
          <div className="mt-8 space-x-4">
            <a href="#" className="px-10 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700">Przycisk 1</a>
            <a href="#" className="px-10 py-3 border border-gray-300 text-gray-600 rounded-full hover:bg-gray-100">Przycisk 2</a>
          </div>
        </div>
